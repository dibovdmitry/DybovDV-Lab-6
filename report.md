...
##### Приложения
- Скрипты main.py, test_rag_system.py, main_optimized.py, documents/tech_docs.py, retriever/vector_store.py, generator/llm_client.py, pipeline/rag_pipeline.py, evaluation/ в lab-5-2 и lab-5-3.
