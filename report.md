...
Рисунок 9 - График комплексной оценки качества RAG-системы \
![скриншот](report/Screenshot32.png "График комплексной оценки качества RAG-системы") \
Рисунок 10 - График комплексной оценки качества RAG-системы

11. Проверена папка reports с отчётами;
![скриншот](report/Screenshot33.png "Проверка содержимого папки с отчётами") \
Рисунок 11 - Проверка содержимого папки с отчётами
...
- [x] Нагрузочные тесты - базовый стресс‑тест (параллельные запросы) показал деградацию при >50 одновременных запросах на CPU.
